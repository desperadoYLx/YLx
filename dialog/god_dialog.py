...
class GODDialog:
    def __init__(self):
        ...
        """
        # 1 头像照片
        img_path = os.path.join('resource', 'img', 'god', 'waizui.png')
        ...
        text = "我是歪嘴战神，我等你很久了，8年前，我的仇人合伙起来灭了我萧家" \
               " 我在苏家当赘婿隐忍3年，却巧逢机缘突破为歪嘴战神，不能干涉凡事" \
               " 我大仇不报，心结难解。我需要你的力量，我会让你穿越回我即将突破之时" \
               " 那时我已经是歪嘴龙王，我现在传你神功《歪嘴宝典》希望能帮我报仇" \
               " 是否接受歪嘴战神的任务？接受 Y/不接受 N"
